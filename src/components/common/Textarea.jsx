...
const Textarea = ({ 
  ...
  const baseClasses = 'w-full px-4 py-3 rounded-lg border transition-all duration-200 text-right placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-1 resize-none';
